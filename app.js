	...
	for(let j= 0;j<grid.length;j++){
		...
		if(grid[i][j]!=0){
			...
			if(grid[i][j]==2){
				...
				cell.style.backgroundColor="#e0ccff";
			}else if(grid[i][j]==8){
				cell.style.backgroundColor="#a366ff";
			}else if(grid[i][j]==16){
				cell.style.backgroundColor="#6600ff";
			}else if(grid[i][j]==32){
				cell.style.backgroundColor="#e066ff";
			}else if(grid[i][j]==64){
				cell.style.backgroundColor="#ff1ac6";
			}else if(grid[i][j]==128){
				cell.style.backgroundColor="#cc6699";
			}else if(grid[i][j]==256){
				cell.style.backgroundColor="#c6538c";
			}else if(grid[i][j]==512){
				cell.style.backgroundColor="#ff6699";
